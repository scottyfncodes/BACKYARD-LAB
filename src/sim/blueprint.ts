...
/** Things on a string (balloons) are squishy: bunches can share a space. */
const isSoft = (def: PartDef) => def.sockets.some((s) => s.joint === 'tether');
